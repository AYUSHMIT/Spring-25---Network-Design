...
Environment 
OS used for our code: Windows 10
...
* server.py: This file contains the code for the server application, which receives the JPEG image file from the client using the RDT 2.2 protocol.
...
4. In the first terminal, navigate to the directory containing the server code and run the command `python server.py`.
...
1. Ensure that the `performance_plots.py`, `client_phase_2.py`, `server.py`, and `file_transfer.py` files are in the same directory.
2. Open a terminal or command prompt.
